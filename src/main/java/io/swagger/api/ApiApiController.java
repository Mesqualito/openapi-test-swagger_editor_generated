...
public class ApiApiController implements ApiApi {
    ...
    public ResponseEntity<VendorDTO> createNewCustomerUsingPOST1(@ApiParam(value = "vendorDTO" ,required=true )  @Valid @RequestBody VendorDTO vendorDTO) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("")) {
            try {
    ...
    public ResponseEntity<CategoryListDTO> getAllCategoriesUsingGET() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("")) {
            try {
                return new ResponseEntity<CategoryListDTO>(objectMapper.readValue("", CategoryListDTO.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
                log.error("Couldn't serialize response for content type ", e);
    ...
    public ResponseEntity<CustomerListDTO> getAllCustomersUsingGET() {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("")) {
            try {
    ...
    public ResponseEntity<CustomerDTO> patchCustomerUsingPATCH(@ApiParam(value = "customerDTO" ,required=true )  @Valid @RequestBody CustomerDTO customerDTO,@ApiParam(value = "id",required=true) @PathVariable("id") Long id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("")) {
            try {
                return new ResponseEntity<CustomerDTO>(objectMapper.readValue("", CustomerDTO.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<CustomerDTO> updateCustomerUsingPUT(@ApiParam(value = "customerDTO" ,required=true )  @Valid @RequestBody CustomerDTO customerDTO,@ApiParam(value = "id",required=true) @PathVariable("id") Long id) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("")) {
            try {
                return new ResponseEntity<CustomerDTO>(objectMapper.readValue("", CustomerDTO.class), HttpStatus.NOT_IMPLEMENTED);
